        ...
        protected void onPostExecute(String s) {
            ...
            if (Status==1){
                ...
                if (radioButtonhome.isChecked() || radioButtonoffice.isChecked()) {
                    ...
                    Intent intent = new Intent(AddAddress2Activity.this, PlaceOrderActivity.class);
                    ...
                    Toast.makeText(AddAddress2Activity.this, "Select Address Type", Toast.LENGTH_LONG).show();
                }

...
public class EditCartAdapter extends RecyclerView.Adapter<EditCartAdapter.ListHolder> {
    ...
    private ClickOnDeleteListener clickOnDeleteListener;
...
//        void iconImageViewOnClick(View v, int position);
    ...
    public interface ClickOnDeleteListener {
        void onDeleteItemClick(String position);
        //int position;

    }

    public void setOnDeleteClick(ClickOnDeleteListener listner){
        this.clickOnDeleteListener = listner;
...
//                }
        ...
        holder.imageViewdelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               String itemname = holder.textViewsubitemname.getText().toString();

                clickOnDeleteListener.onDeleteItemClick(itemname);
            }
        });

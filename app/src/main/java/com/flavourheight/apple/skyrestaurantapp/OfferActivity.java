...
import com.flavourheight.apple.skyrestaurantapp.Adapter.OfferAdapter;
...
//        imageViewback=(ImageView)findViewById(R.id.imgofferback);
...
//        });
    ...
    class getofferlist extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... voids) {
            ...
            String url = path + "Offers/GetAllOffer";
            Log.d("Url: ", "> " + url);

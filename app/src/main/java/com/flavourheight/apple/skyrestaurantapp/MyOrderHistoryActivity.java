...
public class MyOrderHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(MyOrderHistoryActivity.this, MyAccountActivity.class);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyOrderHistoryActivity.this));
    }
    ...
    class getOrder extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = new ProgressDialog(MyOrderHistoryActivity.this);

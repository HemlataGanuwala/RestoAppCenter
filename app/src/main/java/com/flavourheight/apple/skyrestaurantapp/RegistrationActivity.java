...
//        }
        ...
        if(!emailid.equals(dataemail)) {

            if (!phoneno.equals(datamobile))
            {
                validation();
            }
            else {
    ...
    public void validation()
    {
        ...
        else if (conformpass.isEmpty() || !conformpass.equals(password))
        {
            ...
            databaseHelpher.RegistrationData(fname, lname, emailid, phoneno, password,0);
...
//            progress.show();
    ...
    class RegisterData extends AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            ...
            progress.setMessage("Loading...");
            Toast.makeText(RegistrationActivity.this, "general test", Toast.LENGTH_SHORT).show();
            progress.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            progress.setIndeterminate(true);
            progress.setProgress(0);
            progress.show();
        ...
        protected String doInBackground(String... strings) {
            ...
            Toast.makeText(RegistrationActivity.this, "Wait for data", Toast.LENGTH_SHORT).show();

            shh = new ServiceHandler();
            String url = path + "Registrations/AddNewRegistrations";

            Toast.makeText(RegistrationActivity.this, "Get json data", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                params2.add(new BasicNameValuePair("RAmount",""));
                params2.add(new BasicNameValuePair("EatingPreferance",""));
                params2.add(new BasicNameValuePair("Gender",""));
